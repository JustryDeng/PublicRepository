...
public class SpringBootForJavaAnnotationApplicationTests {
	...
	public void singleSelectAcceptDataByMapTest() {
		Map<String, Object> map = javaAnnotationMapper.singleSelectAcceptDataByMap("小丁");
	...
	public void dynamicSelectMultiParamTest() {
		...
		for (Map<String, Object> resultMap : resultMapList) {
			...
			System.out.println(resultMap.get("e_name"));
			System.out.println(resultMap.get("e_age"));
			System.out.println(resultMap.get("e_gender"));
		}
	}
	...
	public void  executeSQLScriptTest() {
		...
		list.add(7);
		list.add(9);
		List<Employee> result = javaAnnotationMapper.executeSQLScript(list);
		System.out.println(result);
	}
