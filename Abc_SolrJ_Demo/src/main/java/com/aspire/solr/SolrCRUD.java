...
/**
 * 对Dtaimport进Solr中的数据进行CRUD
 *
 * @author JustryDeng
 * @date 2018年8月10日 上午1:00:36
 */
public class SolrCRUD {
	...
	public void solrAddOrUpdate() {
		 ...
		 */
		document.addField("id", "67689");
		document.addField("name", "JustryDeng");
	...
	public void solrDelete() {
		...
		try {
			// 执行删除
			httpSolrClient.deleteByQuery("id:67689");
			// 再给出两种常用的删除方式
	 ...
	 *
	 * @param args
	 * @date 2018年8月10日 下午2:48:27
	 */
	public static void main(String[] args) {
		SolrCRUD solrDemo = new SolrCRUD();
//		solrDemo.solrQuery();
