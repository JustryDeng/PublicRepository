...
public class UpFileController {
	...
	public void fileUpload(@RequestParam("fileName") MultipartFile file, @RequestParam("gender") String gender) {
	...
	public void mulFileUpload(@RequestParam("files") MultipartFile[] files) {
		// 先设定一个放置上传文件的文件夹(该文件夹可以不存在，下面会判断创建)
		String deposeFilesDir = "C:\\Users\\dengshuai.ASPIRE\\Desktop\\file\\";
