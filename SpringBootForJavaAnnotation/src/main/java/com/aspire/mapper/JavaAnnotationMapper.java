...
public interface JavaAnnotationMapper {
	 ...
	 */
	@Insert("INSERT INTO employee (e_name,e_age,e_gender) VALUES"
			+ "(#{e.name},#{e.age},#{e.gender}),"
			+ "(#{name0},#{age0},#{gender0})")
	@Options(useGeneratedKeys = true, keyProperty = "e.id", keyColumn = "id")
	int singleInsertMultiParam(@Param("e") Employee employee,
			@Param("name0") String name,@Param("age0") Integer age,@Param("gender0") String gender);
